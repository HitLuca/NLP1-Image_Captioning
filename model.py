...
class Caption_Generator():
    ...
    def build_model(self):
        ...
        # state = tf.zeros([self.batch_size, 256])
...
def preProBuildWordVocab(sentence_iterator, word_count_threshold=15): # borrowed this function from NeuralTalk
    ...
    # word_counts = {}
    # nsents = 0
    # for caption in sentence_iterator:
    #     sentences = caption[1]
    #     for sentence in sentences:
    #         nsents += 1
    #         for word in sentence:
    #             word_counts[word] = word_counts.get(word.lower(), 0) + 1
    #
    # vocab = [w for w in word_counts if word_counts[w] >= word_count_threshold]
...
# data_path = './data'
feat_path = './merged_train.npy'
annotation_path = './merged_train.json'
################################################################
...
def train():
    ...
    for epoch in range(n_epochs):
        ...
        for start, end in zip(range(0, len(feats), batch_size),range(batch_size, len(feats), batch_size)):
            ...
            # print 'Preprocessing duration ', time.time() - start_time2
            ...
            # print 'Loss duration: ', time.time() - start_time3
            # print 'Total Duration: ', end_time2
